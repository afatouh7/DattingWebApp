    ...
    public partial class identityadded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SorceUserId = table.Column<int>(type: "int", nullable: false),
                    LikeUserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.SorceUserId, x.LikeUserId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Likes_AspNetUsers_SorceUserId",
                        column: x => x.SorceUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
